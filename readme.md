...
![登录发现本地没有私钥](./imgs/image-20200323142504017.png)

如果输入错误的私钥，会提示私钥格式错误并重新登录流程。

![私钥格式错误](./imgs/image-20200323142602861.png)

私钥如果输入正确返回结果，然后向服务器进行登录请求。

![检测结果返回](./imgs/image-20200323142643811.png)

在服务器验证阶段如果失败也会提示错误并重新开始登录流程。

![服务器方登录失败，密码错误](./imgs/image-20200323142707494.png)
...
![没有搜索到目标](./imgs/image-20200323142852111.png)

![搜索自己](./imgs/image-20200323142924564.png)

![搜索好友](./imgs/image-20200323143003381.png)

![搜索好友](./imgs/image-20200323143034214.png)
...
![待定好友](./imgs/image-20200323143112151.png)
...
![成功接收消息](./imgs/image-20200323143428093.png)
